package com.letansang.simplecalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private double val2;
        ...
        viewSetup();
            Toast.makeText(this, "Made by Le Tan Sang", Toast.LENGTH_SHORT).show();
        ...
        b_percent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this, "Not done yet! Sorry.", Toast.LENGTH_SHORT).show();
...
//                }
        ...
        b_multi = findViewById(R.id.buttonMultiplication);
        b_divide = findViewById(R.id.buttonDivision);
        b_add = findViewById(R.id.buttonAddition);
        b_sub = findViewById(R.id.buttonSubtraction);
        b_clear = findViewById(R.id.buttonC);
        b_dot = findViewById(R.id.buttonDot);
        b_percent = findViewById(R.id.buttonPercent);
        b_para2 = findViewById(R.id.buttonNgoac);
        t1 = findViewById(R.id.textViewinput);
        t2 = findViewById(R.id.textViewoutput);
    }
